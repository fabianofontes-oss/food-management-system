          ...
          <section className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={watchedValues.checkout?.mode || 'phone_required'}
                ...
                <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-700">
                    {watchedValues.checkout?.mode === 'guest' 
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={watchedValues.payments?.pix?.enabled || false}
                ...
                {watchedValues.payments?.pix?.enabled && (
                  <div className="space-y-3 mt-4 pt-4 border-t border-gray-200">
                    <div>
                      ...
                      <select
                        value={watchedValues.payments?.pix?.key_type || ''}
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={watchedValues.payments?.pix?.key || ''}
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={watchedValues.payments?.pix?.receiver_name || ''}
                    ...
                    {errors.payments?.pix && (
                      <p className="text-red-600 text-sm">{errors.payments.pix.message}</p>
                    )}
                  </div>
                )}
              </div>
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={watchedValues.payments?.cash || false}
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={watchedValues.payments?.card_on_delivery || false}
