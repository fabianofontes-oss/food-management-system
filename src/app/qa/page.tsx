  ...
  return (
    <div style={{ padding: '40px', backgroundColor: '#f9fafb', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#6b7280', marginBottom: '24px' }}>Links prontos para todas as rotas - Clique para copiar</p>
          ...
          <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ backgroundColor: '#f9fafb', padding: '12px', borderRadius: '6px', border: '1px solid #e5e7eb' }}>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/cart`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/cart</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/checkout`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer' }}>http://localhost:3000/{slug}/checkout</code>
              </div>
            </div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ backgroundColor: '#f9fafb', padding: '12px', borderRadius: '6px', border: '1px solid #e5e7eb' }}>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/products`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/products</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/orders`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/orders</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/kitchen`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/kitchen</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/delivery`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/delivery</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/crm`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/crm</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/pos`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/pos</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/reports`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/reports</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/coupons`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/coupons</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/team`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer', marginBottom: '4px' }}>http://localhost:3000/{slug}/dashboard/team</code>
                <code onClick={() => copyUrl(`http://localhost:3000/${slug}/dashboard/settings`)} style={{ display: 'block', fontSize: '13px', cursor: 'pointer' }}>http://localhost:3000/{slug}/dashboard/settings</code>
              </div>
            </div>
