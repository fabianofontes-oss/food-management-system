      ...
      <div className="max-w-4xl mx-auto">
        <Card className="border-2 border-dashed border-gray-300">
          <CardContent className="p-12 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Em breve: Logs de Auditoria</h1>
            <p className="text-gray-600 text-lg mb-6">
              Aqui será o painel de auditoria com histórico de ações (create/update/delete) por tenant e usuário.
            </p>
